 ...
 */
Bridge.assembly("OrgChart.Layout.JScript.Bridge", function ($asm, globals) {
    "use strict";
    ...
    Bridge.define("OrgChart.Layout.LayoutAlgorithm", {
        statics: {
            ...
            ResetLayout: function (state) {
                OrgChart.Layout.LayoutAlgorithm.MoveTo(state, 0, 0);
                state.BranchExterior = new OrgChart.Layout.Rect.$ctor1(state.TopLeft, state.Size);
                state.Connector = null;
                state.SiblingsRowV = OrgChart.Layout.Dimensions.MinMax();
            },
            /**
