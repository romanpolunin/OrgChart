...
Bridge.assembly("Staffer.OrgChart.Layout.JScript.Bridge", function ($asm, globals) {
    ...
    Bridge.define("Staffer.OrgChart.Layout.LayoutAlgorithm", {
        statics: {
            ...
            computeBranchVisualBoundingRect: function (visualTree) {
                var result = visualTree.getRoots().getItem(0).getElement().frame.exterior;
    ...
    Bridge.setMetadata(Staffer.OrgChart.Layout.Frame, function () { return {"attr":[new System.Diagnostics.DebuggerDisplayAttribute("{Exterior.Left}:{Exterior.Top}, {Exterior.Size.Width}x{Exterior.Size.Height}")],"members":[{"attr":[new Staffer.OrgChart.Annotations.CanBeNullAttribute()],"accessibility":2,"name":"Connector","type":4,"returnType":Staffer.OrgChart.Layout.Connector,"sname":"connector","isReadOnly":false}]}; });
    ...
    Bridge.setMetadata(Staffer.OrgChart.Layout.LayoutState.LayoutLevel, function () { return {"attr":[new System.Diagnostics.DebuggerDisplayAttribute("{BranchRoot.Element.Id}, {Boundary.BoundingRect.Top}..{Boundary.BoundingRect.Bottom}")]}; });
    ...
    Bridge.setMetadata(Staffer.OrgChart.Layout.Rect, function () { return {"attr":[new System.Diagnostics.DebuggerDisplayAttribute("{TopLeft.X}:{TopLeft.Y}, {Size.Width}x{Size.Height}")]}; });
