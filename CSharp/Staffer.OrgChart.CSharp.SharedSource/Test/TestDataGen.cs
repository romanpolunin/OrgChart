...
namespace Staffer.OrgChart.CSharp.Test.Layout
{
    ...
    public class TestDataGen
    {
        ...
        public static void GenerateBoxSizes([NotNull] BoxContainer boxContainer)
        {
            ...
            foreach (var box in boxContainer.Boxes.Values.Where(x => !x.IsAutoGenerated))
            {
                var size = new Size(minWidth + random.Next(200), minHeight + random.Next(200));
                box.Frame.Exterior = new Rect(size);
            }
        }
    }
}